	...
	<div class="container">
		<section class="wrapper">
			<div class="heading">
				...
				<p class="text text-normal">New user? <span><a href="http://localhost:12080/createaccount" class="text text-links">Create an account</a></span>
				</p>
			</div>
	...
	<div class="container">
		<section class="wrapper">
			<div class="heading">
				...
				<p class="text text-normal">Are you a member? <span><a href="http://localhost:12080/loginuser" class="text text-links">Login</a></span>
				</p>
			</div>
			<form name="signin" class="form">
				<div class="input-control">
            ...
            <div class="input-control">
					<a href="#" class="text text-links">Create</a>
                    <br>
			</div>
			<div class="method">
				<div class="method-control">
